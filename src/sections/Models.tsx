    ...
    <section id="models" ref={sectionRef} className="bg-[#0f0f0f] py-20 md:py-28">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        ...
        >
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-2 -mx-1 px-1 md:mx-0 md:px-0 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
            {filters.map((f) => (
              <button
                key={f.key}
                onClick={() => setActiveFilter(f.key)}
                className={`filter-pill whitespace-nowrap ${activeFilter === f.key ? 'active' : ''}`}
              >
          ...
          {filtered.map((product) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="text-[13px] text-white/40 mt-2 line-clamp-2">
